...
class OtherApps extends CI_Controller {
    public function _construct()
    {
        parent::_construct();
            ...
            $vars['wordpressimage'] = img_path('wordpressimg.jpg');
            ...
            $vars['mobiledevelopmentimage'] = img_path('mobiledevelopmentimg.jpg');
            $vars['othellogameimage'] = img_path('othellogameimg.jpg');
            ...
            $vars['rubyRailsImage'] = img_path('rubyRailsimg.jpg');
            ...
            $vars['doorHandle'] = img_path('doorhandle');
            $vars['bigpic'] = 'my_bigpic.gif';
    ...
    function orominer1(){
        ...
        $this->fuel->pages->render('orominer/orominer1',$this->vars);
    }
    
    function orominer2(){
        $this->vars['whichPage'] = 'orominer2';
        $this->fuel->pages->render('orominer/orominer2',$this->vars);
    }
    ...
    function amino(){
        ...
        $this->fuel->pages->render('amino',$this->vars);
    } 
    ...
    function caribCatering(){
        ...
        $vars['url'] = "http://rlsworks.com/wordpress/vcc";
        $this->fuel->pages->render('showApp',$this->vars);
        
    }
    
    function caribStore(){
       $vars['url'] = "http://rlsworks.com/cfs/wordpress";
       $this->fuel->pages->render('showApp',$this_>vars);
    }
