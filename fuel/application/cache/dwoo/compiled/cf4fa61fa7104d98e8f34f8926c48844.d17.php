    ...
    <head>
       ...
       <meta charset="utf-8">
		...
		<link href='https://fonts.googleapis.com/css?family=Raleway:400,700' rel='stylesheet' type='text/css'>
				<script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script><script>window.jQuery || document.write('<script src="/fuel/assets/js/jquery.js?c=-62169955200"><\/script>');</script>	       
     
	
		<link href = "/fuel/assets/css/headerCSS.css?c=-62169955200" rel="stylesheet" type="text/css" />
		<link href = "/fuel/assets/css/footerCSS.css?c=-62169955200" rel="stylesheet" type="text/css" />
		
		<!-- Custom ThemeRoller files -- excite bike  -->
  		<link href="/fuel/assets/css/excite-bike/jquery-ui-1.10.4.custom.css?c=-62169955200" rel="stylesheet">
		<script src="/fuel/assets/js/jquery-1.10.2.js?c=-62169955200"></script>
		<script src="/fuel/assets/js/jquery-ui-1.10.4.custom.js?c=-62169955200"></script>

		
		

				
						<link href = "/fuel/assets/css/frontCSS.css?c=-62169955200" rel="stylesheet" type="text/css" />
		...
		$(document).ready(function()
			{ 
					 var title = "Portfolio Front Page";
					 pageTitleStr = title;
				   ...
				   var  httpAgent = "Mozilla\/5.0 (X11; Linux x86_64) AppleWebKit\/537.36 (KHTML, like Gecko) Chrome\/73.0.3683.103 Safari\/537.36";
		...
		/********************** HEADER IMAGES SECTION **************************************************************************/		 			
							...
							var upArrow =  "/fuel/assets/images/upArrow.gif";
							var laravelMVCImage =  "/fuel/assets/images/laravelMVC.jpg";
						
						
							var loaderImage =  "/fuel/assets/images/spiral.gif";
							var mhImage1 =  "/fuel/assets/images/worksImg.jpg";
							var mhImage2 =  "/fuel/assets/images/mechEngImage2.jpg";
							var mhImage3 =  "/fuel/assets/images/topLabel.jpg";
							var mhImage4 =  "/fuel/assets/images/engImg.jpg";
							var mhImage5 =  "/fuel/assets/images/compSciImage.jpg";
							var mhImage6 =  "/fuel/assets/images/mathhonorimg.jpg";
							var mhImage7 =  "/fuel/assets/images/procprojengimg.jpg";
							var mhImage8 =  "/fuel/assets/images/technicalwritingimage.jpg";
			...
			/***************************** MOBILE APP HEADER DISPLAY CODE ***************************************************************************/
					      ...
					      if(mobileAppHeaderAdjust == 'on')   // MOBILE APP
						 	{ 
							    ...
							    $('body').prepend('<div id="pGraphic"><div id="positDiv"><h2>RLS Career Porfolio</h2><img src="'+ "http://3.17.190.54/fuel/images/procprojengimg.jpg"+'"/></div></div>');
          ...
          for(var i=0;i<menuTag.length;i++){ 
         	   if(extraFunction[i] == 'llv'){ 
         	   	  ...
         	   	  for(var j=0;j<llvImages[i].length;j++){ 
	         	   	  var siteUrl = "http://3.17.190.54/fuel/index.php";
			          siteUrl = siteUrl.replace('FUEL-CMS/','');
			          var imagePath = '"/fuel/assets/images/'+ 'vegas/' + llvImages[i][j]  +'"';
						...
						{ 
						   ...
						   //alert(slug);
							...
							if(extraFunction != 'llv'){   // Do All Other Apps
										...
										var imagePath = '"/fuel/assets/images/'+ menuImage  +'"';
										imagePath = imagePath.replace('"','');
										imagePath = imagePath.replace('"','');
...
<body>
	...
	<section id="main_inner">
		<!--__FUEL_MARKER__3--><?php echo $this->getSecurityPolicy()->callMethod($this, $this->scope["load"], 'view', array('articles'));?>	</section>
...
<script type="text/javascript">	
	...
	<div id="footContainer" class="ui-widget ui-state-default ui-corner-all">
		<div id="formcontainer" style="visibility:hidden">
										<form action="http://3.17.190.54/fuel/index.php/index2" id="itemform" method="post" accept-charset="utf-8">
