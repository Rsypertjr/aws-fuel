    ...
    <head>
       ...
       <meta charset="utf-8">
		...
		<script src="/FUEL-CMS/assets/js/jquery-ui-1.10.4.custom.js?c=-62169955200"></script>
						...
						<link href = "/FUEL-CMS/assets/css/frontCSS.css?c=-62169955200" rel="stylesheet" type="text/css" />
		...
		$(document).ready(function()
			{ 
				   ...
				   var  httpAgent = "Mozilla\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\/537.36 (KHTML, like Gecko) Chrome\/65.0.3325.181 Safari\/537.36";
		...
		/********************** HEADER IMAGES SECTION **************************************************************************/		 			
			...
			//Software Development Menu in Graphic Display	
					$('#triggerDiv #btn3').on('mouseenter',function(){  
						     ...
						     el.find('.aLi').css('padding','3px').css('height','10.5%');
							 el.hide();
			...
			/*** Generating Header Animations  AND App Selection *******************************************/	
        		...
        		var index2 = "";
        			...
        			menuHTML.push("<p class=\"descHdr\">Angular2 JavaScript with Redux State Container</p><p>Angular2 JavaScript with @ngrx Redux Store Container which gives centralized, immutable state management.</p><p xss=removed>Click Menu Tab to See App, or Click Tabs in this description to See Code.</p>");
        			...
        			url1.push("https://young-wildwood-41737.herokuapp.com");
        			url2.push("");
          ...
          for(var i=0;i<menuTag.length;i++){ 
         	   if(extraFunction[i] == 'llv'){ 
         	   	  ...
         	   	  for(var j=0;j<llvImages[i].length;j++){ 
	         	   	  var siteUrl = "https://fuel-cms-rsypertjr.c9users.io/FUEL-CMS/";
   ...
   function laravelMVCExtra(laravelMVCImage){ 
			...
			' The program uses Facebook and GitHub authentication and allows a user to create contacts and register them with Active Campaign.</p><div id="gLink" style="color:blue;font-style:italic">A Git Repo of the Code is Here</div>');
				...
				$('#gLink').on('mousedown',function(){ 
					$(this).css('color','gray');
					$(location).attr('href',"https://Rsypertjr@bitbucket.org/Rsypertjr/learnlaravel.git");
				}).css('cursor','pointer');	
...
<script type="text/javascript">	
			...
			$(document).ready(function()
				{ 
			        ...
			        var index2 = "";
			        			...
			        			url1.push("https://bitbucket.org/Rsypertjr/profile/repositories?visibility=all");
			        ...
			        var index2 = "";
			        			...
			        			url1.push("http://www.appeng.rlsworks.com");
			        ...
			        var index2 = "";
			        			...
			        			url1.push("https://safe-bayou-92699.herokuapp.com");
			        ...
			        var index2 = "";
			        			...
			        			url1.push("https://safe-bayou-92699.herokuapp.com/cinp");
	...
	<div id="footContainer" class="ui-widget ui-state-default ui-corner-all">
		<div id="formcontainer" style="visibility:hidden">
										<form action="https://fuel-cms-rsypertjr.c9users.io/FUEL-CMS/index2" id="itemform" method="post" accept-charset="utf-8">
