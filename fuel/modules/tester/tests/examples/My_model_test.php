...
class My_model_test extends Tester_base {
	...
	{
		parent::__construct();
		$this->dbase = new MY_Model();
	}

	public function setup()
	{
		$this->load_sql('../sql/test_fuel_schema.sql', 'tester');
		$this->load_sql('../sql/test_generic_schema.sql', 'tester');

		// load a basic models to test
		require_once('Test_users_model.php');
	//require_once('Test_roles_model.php');
	}
