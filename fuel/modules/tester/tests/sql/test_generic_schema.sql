...
CREATE TABLE `roles` (
  ...
  `context` varchar(30) collate utf8_unicode_ci NOT NULL,
  `active` enum('yes','no') collate utf8_unicode_ci NOT NULL default 'yes',
  `date_added` datetime DEFAULT NULL,
  PRIMARY KEY  (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `roles` (`role_id`,`name`,`slug`,`context`, `active`, `date_added`)
VALUES
 (1,'Jedi','jedi','jedi',1,'2012-01-01'),
 (2,'Droid','droid','droid',1,'2012-01-01'),
 (3,'Ewok','droid','ewok',1,'2012-01-01')
 ;
